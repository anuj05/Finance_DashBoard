...
!(function(t, e) {
            ...
            toPadding: function(t) {
                ...
                return (
                    ...
                    ((e = +t.top || 0),
                        ...
                        (n = +t.bottom || 0),
                        (a = +t.left || 0)) :
                    (e = i = n = a = +t || 0), { top: e, right: i, bottom: n, left: a, height: e + n, width: a + i }
                );
            },
    ...
    ut.extend(wt.prototype, {
            ...
            transition: function(t) {
                for (
                    var e = this.getMeta(), i = e.data || [], n = i.length, a = 0; a < n;
                    ++a
                )
                    i[a].transition(t);
    ...
    function Rt(t) {
        ...
        return (
            ...
            ((o = t.height / 2),
                ...
                (n = t.y - o),
                (a = t.y + o)), { left: e, top: n, right: i, bottom: a }
        );
    }
    ...
    var Yt = Mt.extend({
            ...
            calculateBarValuePixels: function(t, e) {
                ...
                return (
                    ...
                    void 0 !== g &&
                    Math.abs(s) < g &&
                    ((s = g), (r = (f >= 0 && !h) || (f < 0 && h) ? o - g : o + g)), { size: s, base: o, head: r, center: r + s / 2 }
                );
            },
                    ...
                    (function(t, e, i) {
                        ...
                        return (
                            ...
                            ((n = e.min * i.categoryPercentage),
                                (a = i.barPercentage)) :
                            ((n = o * r), (a = 1)), { chunk: n / r, ratio: a, start: s - n / 2 }
                        );
                    })(e, i, n),
            ...
            draw: function() {
                ...
                for (
                    ...
                    ((t = (i.dataset._model.borderWidth || 0) / 2),
                        ...
                        i.dataset.draw(),
                        ut.canvas.unclipArea(e.ctx)); r < o;
                    ++r
                )
                    n[r].draw(a);
            },
    ...
    var ke = {
        ...
        configure: function(t, e, i) {
            for (
                var n, a = ["fullWidth", "position", "weight"], o = a.length, r = 0; r < o;
                ++r
            )
            ...
            merger: function(t, e, i, n) {
                if ("xAxes" === t || "yAxes" === t) {
                    ...
                    for (e[t] || (e[t] = []), a = 0; a < s; ++a)
                        ...
                        a >= e[t].length && e[t].push({}), !e[t][a].type || (r.type && r.type !== e[t][a].type) ?
            ...
            update: function(t) {
                ...
                if (
                    ((t && "object" == typeof t) ||
                        ...
                        Ee._invalidate(n), !1 !== Ee.notify(n, "beforeUpdate"))
                ) {
                ...
                if (n.length && t.options.display && t.isHorizontal())
                    for (
                        var r,
                            ...
                            l = s,
                            d = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; l > d && o < i.maxRotation;
                ...
                var t = this,
                    ...
                    a = (t.ticks = (function(t, e) {
                        ...
                        (o = Math.ceil(g / p) - Math.floor(f / p)) > d &&
                            ...
                            (a = Math.ceil(g / p) * p),
                            s &&
                            (!vi(u) && ut.almostWhole(u / p, p / 1e3) && (n = u), !vi(h) && ut.almostWhole(h / p, p / 1e3) && (a = h)),
                            (o = (a - n) / p),
                        ...
                        if (s > 0 || n.reverse) {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    a.fillRect(-u / 2 - n.backdropPaddingX, -l - r.size / 2 - n.backdropPaddingY,
    ...
    function $i(t, e, i, n) {
        ...
        for (
            ...
            (u = (function(t, e, i, n) {
                ...
                for (
                    a = 0, o = u.length; a < o && ((r = u[a]), !(Math.ceil(s / (d * r)) <= n));
                    ++a
                );
                return r;
            })(e, i, l, n)),
                            ...
                            (a.time.min ||
                                ...
                                ((r = Xi(t, "time", e[e.length - 1], "pos")),
                                    (l =
                                        1 === e.length ?
                                        r :
                                        (r - Xi(t, "time", e[e.length - 2], "pos")) / 2))), { start: s, end: l }
                        );
                    })(n._table, d, 0, 0, r)),
